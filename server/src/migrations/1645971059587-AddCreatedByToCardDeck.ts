...
export class AddCreatedByToCardDeck1645971059587 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        /** add admin user with password 'admin' (Alter this in production) */
        await queryRunner.query(`INSERT INTO "public"."player" (email, username, password) VALUES('admin@fasoner.party', 'admin', '$2b$10$CbKZQzkbyagCpvtXj9zfxuRuZwqtAd/6G/HiXfZLwpmWmE6lsOeaq')`)
